    ...
    <div className="flex items-center justify-center bg-gradient-to-r from-purple-50 via-pink-50 to-red-50">
      <div className="bg-white p-10 rounded-3xl shadow-lg transform transition duration-500 hover:scale-105 w-full max-w-md">
        ...
        >
          ...
          >
            <Input className="px-5 py-3 border border-gray-500 rounded-full focus:outline-none focus:ring-4 focus:ring-purple-700 transition duration-300" />
          </Form.Item>
          ...
          >
            <Input.Password className="px-5 py-3 border border-gray-500 rounded-full focus:outline-none focus:ring-4 focus:ring-purple-700 transition duration-300" />
          </Form.Item>

          <Form.Item>
            <Button
              className="w-full py-3 px-6 bg-gradient-to-r from-purple-700 to-pink-300 hover:from-pink-500 hover:to-red-300 text-white font-semibold rounded-full shadow-lg transition duration-300 transform hover:scale-105"
              type="primary"
              htmlType="submit"
            >
              Sign in
