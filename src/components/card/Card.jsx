      ...
      <div className="rounded-[15px] border mb-7 relative" key={car._id}>
        ...
        <div className="flex flex-col gap-2 p-[5px_0_25px_16px] items-start justify-end">
          ...
          <div className="absolute top-0 right-0">
            <button
              className="rounded-[0_15px] px-[10px] text-[16px] text-[#fff] py-[5px] bg-[#4acd90]"
            >
              <FaHeart />
            </button>
          </div>
          <div>
            <div className="flex">
              ...
              <p className="text-[#4acd90] text-[14px] font-[400]">
                {" "}
                {car.transmission}
              </p>
            </div>
            <div className="flex  gap-[20px]">
              <div className="flex gap-2 mt-2 items-center">
                <strong className="text-[18px] text-[#4acd90] font-[700]">
                  ${car.price}
                </strong>
              ...
              >
                <IoCartOutline className="text-[#4acd90]" />{" "}
                <p className="text-[13px] text-[#4acd90] font-[500]">Add</p>
              </button>
            </div>
          </div>
        </div>
